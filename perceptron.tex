...
\begin{document}
    ...
    \section{编程实现和实验统计}
		...
		\begin{figure}[htbp]
			...
			\includegraphics[width=6.5cm]{./fig/iter0.png}
			}
			\subfigure[第1次迭代$w_1$]{
			\includegraphics[width=6.5cm]{./fig/iter1.png}
			}
			\subfigure[第2次迭代$w_2$]{
			\includegraphics[width=6.5cm]{./fig/iter2.png}
			}
			\subfigure[第3次迭代$w_3$]{
			\includegraphics[width=6.5cm]{./fig/iter3.png}
			}
			\subfigure[第4次迭代$w_4$]{
			\includegraphics[width=6.5cm]{./fig/iter4.png}
			}
			\subfigure[第5次迭代$w_5$,终止]{
			\includegraphics[width=6.5cm]{./fig/iter5.png}
			}
		...
		\subsection{实际迭代次数$t$和最大迭代次数$T$的分布情况}
			...
			\begin{figure}[htbp]
				\centering
				\subfigure[$t$]{
				\includegraphics[width=6.5cm]{./fig/t.png}
				}
				\subfigure[$\log t$]{
				\includegraphics[width=6.5cm]{./fig/log_t.png}
				}
				\subfigure[$T$]{
				\includegraphics[width=6.5cm]{./fig/T.png}
				}
	...
	\appendix
		...
		\label{sec:pythoncode}
		    \lstinputlisting [language = Python] { ./Python/perceptron_demo.py }
